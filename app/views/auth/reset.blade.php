		...
		<div class="col-md-8 col-md-offset-2">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form" method="POST" action="@if (!isset($change_password_token)){{route('post.reset')}}
					@else {{route('post.change.password')}} @endif">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">

						@if (!isset($change_password_token))
